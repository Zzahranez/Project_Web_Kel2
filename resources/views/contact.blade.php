    ...
    <main>
      <div class="my-6">
        <div
          ...
          <div>
            <h1 class="text-3xl font-extrabold">Mari Bicara</h1>
            <p class="text-sm text-gray-400 mt-3">Punya ide besar atau ingin mengembangkan brand restoran Anda dan
              membutuhkan bantuan? Hubungi kami, kami senang mendengar tentang proyek Anda dan siap memberikan bantuan.
            </p>
            <div class="mt-12">
              ...
              <ul class="mt-3">
                <li class="flex items-center">
                  ...
                  <a href="javascript:void(0)" class="text-[#007bff] text-sm ml-3">
                    ...
                    <strong>zahranezaldi123@gmail.com</strong>
                  </a>
                </li>
              </ul>
            </div>
            <div class="mt-12">
              ...
              <ul class="flex mt-3 space-x-4">
                ...
                <a href="https://www.instagram.com/zahranezldi__/?hl=en">
